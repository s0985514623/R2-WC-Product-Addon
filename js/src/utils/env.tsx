...
export const renderId2 = window?.[APP_DOMAIN]?.env?.RENDER_ID_2 || 'my_app_metabox'

export const apiUrl = window?.wpApiSettings?.root || '/wp-json'
export const ajaxUrl = window?.[APP_DOMAIN]?.env?.ajaxUrl || '/wp-admin/admin-ajax.php'
