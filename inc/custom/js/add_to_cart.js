...
jQuery( document ).ready(
	function ($) {
		...
		$( document ).on(
			'click',
			'button.single_add_to_cart_button:not(.bundle_add_to_cart_button)',
			function (event) {
		...
		$( document ).on(
			'click',
			'.single_add_to_cart_button[name].bundle_add_to_cart_button',
			function (event) {
				...
				$( '.bundled_product_checkbox:checked' ).each(
					function () {
